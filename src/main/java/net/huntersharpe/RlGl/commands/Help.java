...
public class Help implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext arguments) throws CommandException {
        ...
        switch(arguments.getOne("command").get().toString()){
            case "create":
                src.sendMessage(Texts.of(TextColors.DARK_GRAY,
                        "----------[",
                        TextColors.AQUA,
                        "Create",
                        TextColors.DARK_GRAY, "]----------"
                ));
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl create <id> <name>"));
                src.sendMessage(Texts.of(TextColors.GREEN, "- Create arena with specified ID."));
                src.sendMessage(Texts.of(TextColors.GREEN, "- <id> = ID# of intended arena to create."));
                src.sendMessage(Texts.of(TextColors.GREEN, "- <name> = Name specified for the arena."));
                break;
            case "delete":
                src.sendMessage(Texts.of(TextColors.DARK_GRAY,
                        "----------[",
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl <del|delete> <id>"));
            ...
            case "set":
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl set <id>"));
            ...
            case "setend":
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl setend <start|end>"));
            ...
            case "setstart":
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl setstart <start|end>"));
            ...
            case "start":
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl start <id>"));
            ...
            case "help":
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl help <command>"));
            ...
            case "join":
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl join"));
            ...
            case "leave":
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl leave"));
            ...
            case "rlgl":
                ...
                src.sendMessage(Texts.of(TextColors.BLUE, "Usage: /rlgl <create|del|set|setend|setstart|start|stop|join|leave|help>"));
                ...
                break;
            default:
                src.sendMessage(Texts.of(TextColors.RED, arguments.getAll("command"), " is not a valid rlgl command."));
                break;
        }
        return CommandResult.success();
    }
